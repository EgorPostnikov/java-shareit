...
public class RequestServiceTest {
  /*  @Mock
    ...
    ItemRequest itemRequest = new ItemRequest(
            ...
            LocalDateTime.now(),
            new HashSet<>());
    ItemRequestDtos itemRequestDto = new ItemRequestDtos(
            1L,
            "Описание тест",
            1L,
            LocalDateTime.now(),
    ...
    void tesGetItemRequestByIdWithMockOk() {
        ...
        ItemRequestDtos itemRequestDto = itemRequestServiceImpl.getItemRequestById(1L, 1L);
    ...
    void getItemRequests() {
        ...
        Collection<ItemRequestDtos> gotRequests = itemRequestServiceImpl.getItemRequests(1L);
        ItemRequestDtos gotRequest = gotRequests.stream().findFirst().get();
    ...
    void getAnotherItemRequests() {
        ...
        Collection<ItemRequestDtos> gotRequests = itemRequestServiceImpl.getAnotherItemRequests(1L, pageRequest);
        ItemRequestDtos gotRequest = gotRequests.stream().findFirst().get();
        Assertions.assertEquals(1, gotRequests.size());
        Assertions.assertEquals(itemRequest.getId(), gotRequest.getId());
        Assertions.assertEquals(itemRequest.getRequestor(), gotRequest.getRequestor());
    ...
    void getItemRequestById() {
        ...
        ItemRequestDtos gotItemRequest = itemRequestServiceImpl.getItemRequestById(1L, 1L);
    ...
    void createItemRequest() {
        ...
        ItemRequestDtos gotItemRequest = itemRequestServiceImpl.createItemRequest(itemRequestDto);
